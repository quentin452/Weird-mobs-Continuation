...
import com.zurragamez.wmm.item.ItemCookedFood;
import com.zurragamez.wmm.item.ItemCrystal;
import com.zurragamez.wmm.item.ItemFly;
import com.zurragamez.wmm.item.ItemNecklace;
import com.zurragamez.wmm.item.ItemNetherStarPiece;
import com.zurragamez.wmm.item.ItemPotionStick;
import com.zurragamez.wmm.item.ItemRawFood;
import com.zurragamez.wmm.item.ItemSpawnWitherCreeper;
import com.zurragamez.wmm.item.ItemStickManHead;
...
public class WeirdMobsMod {
   ...
   public static final ArmorMaterial bigEarArmor = EnumHelper.addArmorMaterial("BIGEARARMOR", 15, new int[]{2, 4, 3, 1}, 10);
   public static final ArmorMaterial stickManArmor = EnumHelper.addArmorMaterial("STICKMANARMOR", 1, new int[]{1, 1, 1, 1}, 0);
   public static final ToolMaterial potionStickTool = EnumHelper.addToolMaterial("POTIONSTICKTOOL", 0, 20, -3.0F, 0.0F, 10);
   public static final Item netherStarPiece = (new ItemNetherStarPiece(1000)).setUnlocalizedName("NetherStarPiece").setTextureName("WeirdMobsMod:netherStarPiece");
   public static final Item bigEarSkin = (new ItemBigEarSkin(1001)).setUnlocalizedName("BigEarSkin").setTextureName("WeirdMobsMod:bigEarSkin");
   public static final Item fly = (new ItemFly(1002)).setUnlocalizedName("Fly").setTextureName("WeirdMobsMod:fly");
   ...
   public WeirdMobsMod() {
      ...
      GameRegistry.addRecipe(new ItemStack(Items.nether_star), new Object[]{" N ", "NDN", " N ", 'N', netherStarPiece, 'D', Items.diamond});
      GameRegistry.addRecipe(new ItemStack(Blocks.dirt), new Object[]{"FFF", "FFF", "FFF", 'F', fly});
      GameRegistry.addRecipe(new ItemStack(potionStick, 2), new Object[]{" P ", "S#W", " # ", 'P', new ItemStack(Items.potionitem, 1, 8196), 'S', new ItemStack(Items.potionitem, 1, 8234), 'W', new ItemStack(Items.potionitem, 1, 8232), '#', Items.stick});
      ...
      GameRegistry.addRecipe(new ItemStack(necklace), new Object[]{" s ", "sgs", " c ", 's', Items.string, 'g', Items.gold_ingot, 'c', crystal});
      GameRegistry.addRecipe(new ItemStack(spawnWitherCreeper), new Object[]{"fff", "bgb", "fff", 'f', evilFly, 'b', Items.blaze_rod, 'g', Items.gold_ingot});
      GameRegistry.addRecipe(new ItemStack(evilFly), new Object[]{"nsn", "sfs", "nsn", 'f', fly, 'n', Items.nether_wart, 's', Items.spider_eye});
      ...
      EntityRegistry.registerGlobalEntityID(EntityBigFish.class, "Big Fish", EntityRegistry.findGlobalUniqueEntityId());
      EntityRegistry.addSpawn(EntityBigFish.class, 70, 5, 15, EnumCreatureType.waterCreature, new BiomeGenBase[]{BiomeGenBase.ocean});
      this.registerSpawnEgg(EntityBigFish.class, 3227729, 5316640);
      EntityRegistry.registerGlobalEntityID(EntityBUDRBot.class, "BUDR Bot", EntityRegistry.findGlobalUniqueEntityId());
      ...
      EntityRegistry.registerGlobalEntityID(EntityCoohBird.class, "Cooh Bird", EntityRegistry.findGlobalUniqueEntityId());
      ...
      EntityRegistry.registerGlobalEntityID(EntityDistortedMan.class, "Distorted Man", EntityRegistry.findGlobalUniqueEntityId());
      ...
      EntityRegistry.addSpawn(EntityFatFish.class, 70, 5, 15, EnumCreatureType.waterCreature, new BiomeGenBase[]{BiomeGenBase.ocean});
      ...
      EntityRegistry.registerGlobalEntityID(EntityGooftile.class, "Gooftile", EntityRegistry.findGlobalUniqueEntityId());
      ...
      EntityRegistry.registerGlobalEntityID(EntitySpiderCreeper.class, "Spider Creeper", EntityRegistry.findGlobalUniqueEntityId());
      ...
      EntityRegistry.registerGlobalEntityID(EntityTerrorTrickster.class, "Terror Trickster", EntityRegistry.findGlobalUniqueEntityId());
      ...
      EntityRegistry.registerGlobalEntityID(EntityTrinitope.class, "Trinitope", EntityRegistry.findGlobalUniqueEntityId());
      ...
      EntityRegistry.registerGlobalEntityID(EntityWalkingPainting.class, "Walking Painting", EntityRegistry.findGlobalUniqueEntityId());
   ...
   public void registerSpawn(Class c, int spawnNumber, int min, int max, EnumCreatureType type) {
      for(int i = 0; i < BiomeGenBase.getBiomeGenArray().length; ++i) {
         if (BiomeGenBase.getBiomeGenArray()[i] != null && (BiomeGenBase.getBiomeGenArray()[i] != BiomeGenBase.ocean || BiomeGenBase.getBiomeGenArray()[i] != BiomeGenBase.river)) {
            EntityRegistry.addSpawn(c, spawnNumber, min, max, type, new BiomeGenBase[]{BiomeGenBase.getBiomeGenArray()[i]});
         }
      }
   ...
   static {
      potionStick = (new ItemPotionStick(1003, potionStickTool)).setUnlocalizedName("PotionStick").setTextureName("WeirdMobsMod:potion_stick");
      bigEarArmorHelmet = (new ItemBigEarArmor(bigEarArmor, BA1, 0)).setUnlocalizedName("BigEarHelmet").setTextureName("WeirdMobsMod:BigEarArmorHelmet");
      bigEarArmorChestplate = (new ItemBigEarArmor(bigEarArmor, BA2, 1)).setUnlocalizedName("BigEarChestplate").setTextureName("WeirdMobsMod:BigEarArmorChestplate");
      bigEarArmorLeggings = (new ItemBigEarArmor(bigEarArmor, BA3, 2)).setUnlocalizedName("BigEarLeggings").setTextureName("WeirdMobsMod:BigEarArmorLeggings");
      bigEarArmorBoots = (new ItemBigEarArmor(bigEarArmor, BA4, 3)).setUnlocalizedName("BigEarBoots").setTextureName("WeirdMobsMod:BigEarArmorBoots");
      stickManHead = (new ItemStickManHead(stickManArmor, 1, 0)).setUnlocalizedName("Stick Man Head").setTextureName("WeirdMobsMod:stickManHead");
      necklace = (new ItemNecklace(1004)).setUnlocalizedName("Necklace").setTextureName("WeirdMobsMod:necklace");
      crystal = (new ItemCrystal(1005)).setUnlocalizedName("Crystal").setTextureName("WeirdMobsMod:crystal");
      spawnWitherCreeper = (new ItemSpawnWitherCreeper(1006)).setUnlocalizedName("Spawn Wither Creeper").setTextureName("WeirdMobsMod:spawnWitherCreeper");
      evilFly = (new ItemFly(1007)).setUnlocalizedName("Evil Fly").setTextureName("WeirdMobsMod:evil_fly");
      crazyBirdRaw = (new ItemRawFood(1008, 2, false)).setUnlocalizedName("Raw Crazy Bird").setTextureName("WeirdMobsMod:rawCrazyBird");
      crazyBirdCooked = (new ItemCookedFood(1009, 6, false)).setUnlocalizedName("Cooked Crazy Bird").setTextureName("WeirdMobsMod:cookedCrazyBird");
      fatManRaw = (new ItemRawFood(1010, 2, false)).setUnlocalizedName("Raw Fat Man").setTextureName("WeirdMobsMod:rawFatMan");
      fatManCooked = (new ItemCookedFood(1011, 6, false)).setUnlocalizedName("Cooked Fat Man").setTextureName("WeirdMobsMod:cookedFatMan");
      terrorTricksterBlock = (new BlockTerrorTricksterBlock(300, Material.grass)).setBlockName("TerrorTricksterBlock").setBlockTextureName("stone");
   }
}
