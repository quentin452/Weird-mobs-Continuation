...
public class EntityWitherCreeper extends EntityMob implements IBossDisplayData, IRangedAttackMob {
    ...
    public void onLivingUpdate() {
        ...
        for (j = 0; j < 3; ++j) {
            ...
            this.worldObj.spawnParticle(
                "smoke",
                d10 + this.rand.nextGaussian() * 0.3D,
                d2 + this.rand.nextGaussian() * 0.2D,
                d4 + this.rand.nextGaussian() * 0.3D,
                0.0D,
                0.0D,
                0.0D);
            if (flag && this.worldObj.rand.nextInt(4) == 0) {
                this.worldObj.spawnParticle(
                    ...
                    d2 + this.rand.nextGaussian() * 0.1D,
        ...
        if (this.func_82212_n() > 0) {
            for (j = 0; j < 3; ++j) {
                this.worldObj.spawnParticle(
                    ...
                    this.posY + this.rand.nextGaussian() * 0.1D,
    ...
    protected void updateAITasks() {
        ...
        if (this.func_82212_n() > 0) {
                    ...
                    if (this.worldObj.difficultySetting == EnumDifficulty.NORMAL
                        ...
                        if (k1 > 50) {
                            ...
                            double d0 = MathHelper
                                .getRandomDoubleInRange(this.rand, this.posX - (double) f, this.posX + (double) f);
                            double d1 = MathHelper
                                .getRandomDoubleInRange(this.rand, this.posY - (double) f1, this.posY + (double) f1);
                            double d2 = MathHelper
                                .getRandomDoubleInRange(this.rand, this.posZ - (double) f, this.posZ + (double) f);
            ...
            if (this.field_82222_j > 0) {
                --this.field_82222_j;
                if (this.field_82222_j == 0 && this.worldObj.getGameRules()
                    .getGameRuleBooleanValue("mobGriefing")) {
                    ...
                    while (true) {
                        ...
                        for (int i2 = -1; i2 <= 1; ++i2) {
                            for (int j = 0; j <= 3; ++j) {
                                ...
                                if (!block.isAir(this.worldObj, j2, k, l)
                                    && block.canEntityDestroy(this.worldObj, j2, k, l, this)) {
    ...
    private void func_82209_a(int par1, double par2, double par4, double par6, boolean par8) {
        this.worldObj
            .playAuxSFXAtEntity((EntityPlayer) null, 1014, (int) this.posX, (int) this.posY, (int) this.posZ, 0);
