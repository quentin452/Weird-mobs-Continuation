...
public class EntityVestCreeper extends EntityCreeper {
    ...
    public float getCreeperFlashIntensity(float par1) {
        return ((float) this.lastActiveTime + (float) (this.timeSinceIgnited - this.lastActiveTime) * par1)
            ...
            if (this.timeSinceIgnited > 0) {
                for (int l = 0; l < this.var21; ++l) {
                    this.worldObj.spawnParticle(
                        "smoke",
                        this.posX + this.rand.nextGaussian() * 0.10000001192092896D,
                        this.posY + (double) this.height + this.rand.nextGaussian() * 0.10000001192092896D,
                        this.posZ + this.rand.nextGaussian() * 0.10000001192092896D,
                        0.0D,
                        0.0D,
                        0.0D);
                }
