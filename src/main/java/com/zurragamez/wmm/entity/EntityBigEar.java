...
public class EntityBigEar extends EntityTameable {
   ...
   public boolean interact(EntityPlayer par1EntityPlayer) {
      ...
      if (this.isTamed()) {
         if (par1EntityPlayer.getCommandSenderName().equalsIgnoreCase(this.getOwnerName()) && !this.worldObj.isRemote && !this.isHealingFood(itemstack)) {
            ...
            if (par1EntityPlayer.isSneaking() && this.hasNecklace()) {
               ...
               if (!par1EntityPlayer.inventory.addItemStackToInventory(new ItemStack(WeirdMobsMod.necklace))) {
                  par1EntityPlayer.dropPlayerItemWithRandomChoice(new ItemStack(WeirdMobsMod.necklace, 1, 0), false);
               }
            }
         } else if (this.isHealingFood(itemstack) && !this.worldObj.isRemote && this.getHealth() < this.getMaxHealth()) {
