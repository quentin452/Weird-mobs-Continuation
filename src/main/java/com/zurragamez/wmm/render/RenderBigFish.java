...
public class RenderBigFish extends RenderLiving {
    ...
    private static final ResourceLocation texture = new ResourceLocation("WeirdMobsMod:textures/mobs/BigFish.png");
    protected ModelBigFish model;

    public RenderBigFish(ModelBase par1ModelBase, float par2) {
        super(par1ModelBase, par2);
        this.model = this.model;
    }

    public void renderBigFish(EntityBigFish e, double d1, double d2, double d3, float f1, float f2) {
        super.doRender(e, d1, d2, d3, f1, f2);
    }

    public void doRenderLiving(EntityLiving e, double d1, double d2, double d3, float f1, float f2) {
        this.renderBigFish((EntityBigFish) e, d1, d2, d3, f1, f2);
    }
