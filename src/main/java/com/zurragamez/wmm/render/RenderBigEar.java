...
public class RenderBigEar extends RenderLiving {
    ...
    private static final ResourceLocation texture_tamed = new ResourceLocation(
        "WeirdMobsMod:textures/mobs/BigEar_Tamed.png");
    private static final ResourceLocation texture_sitting = new ResourceLocation(
        "WeirdMobsMod:textures/mobs/BigEar_Sitting.png");
    private static final ResourceLocation texture_tamed_necklace = new ResourceLocation(
        "WeirdMobsMod:textures/mobs/BigEar_Tamed_Necklace.png");
    private static final ResourceLocation texture_sitting_necklace = new ResourceLocation(
        "WeirdMobsMod:textures/mobs/BigEar_Sitting_Necklace.png");
    ...
    protected ResourceLocation getEntityTexture(Entity var1) {
        ...
        if (be.getDataWatcher()
            .getWatchableObjectByte(24) == 0) {
            if (be.isSitting()) {
