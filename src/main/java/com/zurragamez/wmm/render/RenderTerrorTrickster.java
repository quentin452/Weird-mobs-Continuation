...
public class RenderTerrorTrickster extends RenderLiving {
    ...
    private static final ResourceLocation texture = new ResourceLocation(
        "WeirdMobsMod:textures/mobs/TerrorTrickster.png");
    private static final ResourceLocation texture_hostile = new ResourceLocation(
        "WeirdMobsMod:textures/mobs/TerrorTrickster_hostile.png");
